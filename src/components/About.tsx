  ...
  return (
    <section className="max-w-7xl mx-auto py-16 px-8" id="about">
          ...
          <div className="bg-secondary rounded-3xl p-6 flex flex-col">
            ...
            <div className="flex-1 flex items-center">
              <Text
                variant="small"
                tag="p"
                text="Soluções sob medida e suporte humano e direto, garantindo atendimento próximo e resultados alinhados às necessidades do seu negócio."
              />
            </div>
          </div>
        </div>
      ...
      <div className="text-center" id="services">
        ...
        <div className={`grid ${isMobile ? "grid-cols-1" : "grid-cols-2"} gap-8 mt-12`}>
          {services[activeTab].map((service, index) => (
            <div key={index} className="bg-secondary rounded-3xl p-6 text-left flex flex-col justify-between">
              <Text
                variant={isMobile ? "small-highlight" : "medium-highlight"}
                tag="h3"
                className="mb-4"
